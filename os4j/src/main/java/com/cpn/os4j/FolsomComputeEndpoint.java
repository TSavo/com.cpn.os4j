...
public class FolsomComputeEndpoint implements Serializable, ComputeEndpoint {
	...
	public FolsomComputeEndpoint(final String aServerUrl, final Token aToken) {
		super();
		token = aToken;
	...
	/* (non-Javadoc)
	 * @see com.cpn.os4j.ComputeEndpoint#getServerUrl()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.cpn.os4j.ComputeEndpoint#getTenantId()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.cpn.os4j.ComputeEndpoint#getToken()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.cpn.os4j.ComputeEndpoint#allocateIPAddress(com.cpn.os4j.model.IPAddressPool)
	 */
	@Override
	@Logged
	public IPAddress allocateIPAddress(final IPAddressPool aPool) {
		...
		command.setUrl(getServerUrl() + "/v2/os-floating-ips");
	...
	/* (non-Javadoc)
	 * @see com.cpn.os4j.ComputeEndpoint#associateIp(com.cpn.os4j.model.Server, com.cpn.os4j.model.IPAddress)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.cpn.os4j.ComputeEndpoint#associateIp(java.lang.String, java.lang.String)
	 */
	@Override
	public Server associateIp(final String aServerId, final String anIpAddress) {
		...
		new RestCommand<Map<String, Map<String, String>>, String>(getServerUrl() + "/v2/servers/" + aServerId + "/action", request, String.class, headerDelegate).post();
		return getServerDetails(aServerId);
	}

	/* (non-Javadoc)
	 * @see com.cpn.os4j.ComputeEndpoint#attachVolume(com.cpn.os4j.model.Server, com.cpn.os4j.model.Volume, java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.cpn.os4j.ComputeEndpoint#attachVolume(java.lang.String, java.lang.String, java.lang.String)
	 */
	@Override
	public VolumeAttachment attachVolume(final String aServerId, final String aVolumeId, final String aDevice) {
		return new RestCommand<VolumeAttachmentMessage, VolumeAttachmentMessage>(getServerUrl() + "/v2/servers/" + aServerId + "/os-volume_attachments", new VolumeAttachmentMessage(new VolumeAttachment(
				aVolumeId, aDevice)), VolumeAttachmentMessage.class, headerDelegate).post().getVolumeAttachment();
	}

	/* (non-Javadoc)
	 * @see com.cpn.os4j.ComputeEndpoint#createServer(java.lang.String, com.cpn.os4j.model.IPAddress, com.cpn.os4j.model.Image, com.cpn.os4j.model.Flavor, java.util.Map, java.util.List, java.lang.String, java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.cpn.os4j.ComputeEndpoint#createServer(java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.util.Map, java.util.List, java.lang.String, java.lang.String)
	 */
	@Override
	public Server createServer(final String aName, final String anIpAddress, final String anImageRef, final String aFlavorRef, Map<String, String> someMetadata, List<SerializedFile> aPersonality,
		...
		command.setHeaderDelegate(headerDelegate);
		command.setUrl(getServerUrl() + "/v2/servers");
	...
	/* (non-Javadoc)
	 * @see com.cpn.os4j.ComputeEndpoint#deallocateIpAddress(int)
	 */
	@Override
	public void deallocateIpAddress(final int anId) {
		final RestCommand<String, String> command = new RestCommand<>();
		command.setHeaderDelegate(headerDelegate);
		command.setUrl(getServerUrl() + "/v2/os-floating-ips/" + anId);
		command.delete();
	}

	/* (non-Javadoc)
	 * @see com.cpn.os4j.ComputeEndpoint#deleteServer(com.cpn.os4j.model.Server)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.cpn.os4j.ComputeEndpoint#deleteServer(java.lang.String)
	 */
	@Override
	public void deleteServer(final String anId) {
		final RestCommand<String, String> command = new RestCommand<>();
		command.setHeaderDelegate(headerDelegate);
		command.setUrl(getServerUrl() + "/v2/servers/" + anId);
		command.delete();
	}

	/* (non-Javadoc)
	 * @see com.cpn.os4j.ComputeEndpoint#suspendServer(java.lang.String)
	 */
	@Override
	public void suspendServer(final String anId) {
		final RestCommand<Map<String, String>, String> command = new RestCommand<>();
		command.setHeaderDelegate(headerDelegate);
		command.setUrl(getServerUrl() + "/v2/servers/" + anId + "/action");
	...
	/* (non-Javadoc)
	 * @see com.cpn.os4j.ComputeEndpoint#suspendServer(com.cpn.os4j.model.Server)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.cpn.os4j.ComputeEndpoint#resumeServer(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.cpn.os4j.ComputeEndpoint#resumeServer(com.cpn.os4j.model.Server)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.cpn.os4j.ComputeEndpoint#pauseServer(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.cpn.os4j.ComputeEndpoint#pauseServer(com.cpn.os4j.model.Server)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.cpn.os4j.ComputeEndpoint#unpauseServer(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.cpn.os4j.ComputeEndpoint#unpauseServer(com.cpn.os4j.model.Server)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.cpn.os4j.ComputeEndpoint#describeAddress(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.cpn.os4j.ComputeEndpoint#detachVolume(com.cpn.os4j.model.Server, com.cpn.os4j.model.Volume)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.cpn.os4j.ComputeEndpoint#detachVolume(java.lang.String, java.lang.String)
	 */
	@Override
	public void detachVolume(final String aServerId, final String aVolumeAttachmentId) {
		final RestCommand<String, String> command = new RestCommand<>();
		command.setHeaderDelegate(headerDelegate);
		command.setUrl(getServerUrl() + "/v2/servers/" + aServerId + "/os-volume_attachments/" + aVolumeAttachmentId);
		command.delete();
	}

	/* (non-Javadoc)
	 * @see com.cpn.os4j.ComputeEndpoint#getIPAddressPoolByName(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.cpn.os4j.ComputeEndpoint#getServerDetails(com.cpn.os4j.model.Server)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.cpn.os4j.ComputeEndpoint#getServerDetails(java.lang.String)
	 */
	@Override
	public Server getServerDetails(final String aServerId) {
		final RestCommand<String, ServerMessage> command = new RestCommand<>();
		command.setHeaderDelegate(headerDelegate);
		command.setUrl(getServerUrl() + "/v2/"+getTenantId()+"/servers/" + aServerId);
		command.setResponseModel(ServerMessage.class);
		return command.get().getServer().setComputeEndpoint(this);
	}

	/* (non-Javadoc)
	 * @see com.cpn.os4j.ComputeEndpoint#listAddresses()
	 */
	@Override
	public List<IPAddress> listAddresses() {
		return new RestCommand<Object, IPAddressMessage>(getServerUrl() + "/v2/os-floating-ips", IPAddressMessage.class, headerDelegate).get().getIpAddresses();
	}

	/* (non-Javadoc)
	 * @see com.cpn.os4j.ComputeEndpoint#listFlavors()
	 */
	@Override
	public List<Flavor> listFlavors() {
		return new RestCommand<Object, FlavorsResponse>(getServerUrl() + "/v2/flavors/detail", FlavorsResponse.class, headerDelegate).get().getFlavors();
	}

	/* (non-Javadoc)
	 * @see com.cpn.os4j.ComputeEndpoint#listImages()
	 */
	@Override
	public List<Image> listImages() {
		return new RestCommand<String, ImagesResponse>(getServerUrl() + "/v2/images/detail", ImagesResponse.class, headerDelegate).get().getImages();
	}

	/* (non-Javadoc)
	 * @see com.cpn.os4j.ComputeEndpoint#listKeyPairs()
	 */
	@Override
	public List<KeyPair> listKeyPairs() {
		return new RestCommand<String, KeyPairResponse>(getServerUrl() + "/v2/"+getTenantId()+"/os-keypairs", KeyPairResponse.class, headerDelegate).get().getKeyPairList();
	}

	/* (non-Javadoc)
	 * @see com.cpn.os4j.ComputeEndpoint#listPools()
	 */
	@Override
	public List<IPAddressPool> listPools() {
		final List<IPAddressPool> pools = new RestCommand<String, IPAddressMessage>(getServerUrl() + "/v2/"+getTenantId()+"/os-floating-ip-pools", IPAddressMessage.class, headerDelegate).get().getPools();
	...
	/* (non-Javadoc)
	 * @see com.cpn.os4j.ComputeEndpoint#listServers()
	 */
	@Override
	public List<Server> listServers() {
		final List<Server> servers = new RestCommand<Object, ServerMessage>(getServerUrl() + "/v2/"+getTenantId()+"/servers/detail", ServerMessage.class, headerDelegate).get().getServers();
	...
	/* (non-Javadoc)
	 * @see com.cpn.os4j.ComputeEndpoint#listVolumeAttachments(com.cpn.os4j.model.Server)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.cpn.os4j.ComputeEndpoint#listVolumeAttachments(java.lang.String)
	 */
	@Override
	public List<VolumeAttachment> listVolumeAttachments(final String aServerId) {
		...
		command.setHeaderDelegate(headerDelegate);
		command.setUrl(getServerUrl() + "/v2/"+getTenantId()+"/servers/" + aServerId + "/os-volume_attachments");
		command.setResponseModel(VolumeAttachmentMessage.class);
		return command.get().getVolumeAttachments();
	}

	/* (non-Javadoc)
	 * @see com.cpn.os4j.ComputeEndpoint#rebootServer(com.cpn.os4j.model.Server, boolean)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.cpn.os4j.ComputeEndpoint#rebootServer(java.lang.String, boolean)
	 */
	@Override
	public Server rebootServer(final String aServerId, final boolean aHard) {
		...
		command.setHeaderDelegate(headerDelegate);
		command.setUrl(getServerUrl() + "/v2/"+getTenantId()+"/servers/" + aServerId + "/action");
	...
	/* (non-Javadoc)
	 * @see com.cpn.os4j.ComputeEndpoint#renameServer(com.cpn.os4j.model.Server, java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.cpn.os4j.ComputeEndpoint#renameServer(java.lang.String, java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.cpn.os4j.ComputeEndpoint#setIpAddress(java.lang.String, java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.cpn.os4j.ComputeEndpoint#createServer(java.lang.String, com.cpn.os4j.model.IPAddress, com.cpn.os4j.model.Image, com.cpn.os4j.model.Flavor, java.util.Map, java.util.List, java.lang.String, java.lang.String, java.lang.Integer, java.lang.Integer, java.util.List)
	 */
	@Override
	public Server createServer(final String aName, final IPAddress anIpAddress, final Image anImage, final Flavor aFlavor, final Map<String, String> someMetadata,
	...
	/* (non-Javadoc)
	 * @see com.cpn.os4j.ComputeEndpoint#createServer(java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.util.Map, java.util.List, java.lang.String, java.lang.String, java.lang.Integer, java.lang.Integer, java.util.List)
	 */
	@Override
	public Server createServer(final String aName, final String anIpAddress, final String anImageRef, final String aFlavorRef, Map<String, String> someMetadata, List<SerializedFile> aPersonality,
		...
		final RestCommand<Map<String, Object>, ServerMessage> command = new RestCommand<>();
		command.setHeaderDelegate(headerDelegate);
		command.setUrl(getServerUrl() + "/v2/"+getTenantId()+"/servers");
		Map<String, Object> map = new HashMap<>();
